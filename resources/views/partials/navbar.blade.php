<nav class="navbar fixed-top navbar-expand-lg navbar-light">
    <div class="container-fluid nav-top">
        ...
        <a class="navbar-brand brand-first fw-bold" id="navbar-brand" href="/">MATIA</a>
        ...
        <form>
            <input type="text" placeholder="Search" spellCheck="false" class="" />
            <button class="btn btn-link search-btn text-dark"><i class="bi bi-search"></i></button>
        </form>
